...
export const getLatestAnime = async () => {
    try {
        const response = await axios.get("https://otakudesu.natee.me/api/home");
...
export const getEpisodeDetails = async (slug) => {
    try {
        const response = await axios.get(`https://otakudesu.natee.me/api/episode/${slug}`);
        return response.data;
    } catch (error) {
        return error.message;
    }
...
export const getAnimeDetails = async (slug) => {
    try {
        const response = await axios.get(`https://otakudesu.natee.me/api/anime/${slug}`);
        return response.data;
    } catch (error) {
        return error.message;
    }
...
export const getSearchResult = async (value) => {
    try {
        const response = await axios.get(`https://otakudesu.natee.me/api/search/${value}`);
        return response.data
    } catch (error) {
        return error.message;
    }
...
export const getCompletedAnime = async (page) => {
    try {
        const response = await axios.get(`https://otakudesu.natee.me/api/completed/page/${page}`);
        return response.data
    } catch (error) {
        return error.message;
    }
...
export const getOngoingAnime = async (page) => {
    try {
        const response = await axios.get(`https://otakudesu.natee.me/api/ongoing/page/${page}`);
        return response.data
    } catch (error) {
        return error.message;
    }
